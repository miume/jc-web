            ...
            <div>
                ...
                <div className='rawStanstdardParent1'>
                    <div className='rawStanstdardParent'>
                        ...
                        <DataPart flag={1} onBlockChange={this.addClick}
                                  className={this.props.home.judgeOperation(this.props.operation, 'SAVE') ? '' : 'hide'}
                                  name='新增原材料' name1='原材料'/>
                        <Modal
                        ...
                        >
                            <RawMaterialAddModal rawData={this.state.rawData} items={this.state.items}
