    ...
    render(){
        ...
        return(
            <div style={{textAlign:'center',marginTop:'20px'}}>
                <Select  onChange={this.props.selectChange} style={{width:'200px',marginRight:'10px'}} placeholder='请选择周期类型'>
                    {
                ...
                <RangePicker placeholder={['开始时间','结束时间']} style={{width:250,marginRight:'10px'}} onChange={this.props.timeChange}></RangePicker>
                
                <span  className={this.props.flag?'':'hide'}>
                    <Select  onChange={this.props.selectChange} style={{width:'200px',marginRight:'10px'}} placeholder='请选择产线'>
                        {
               ...
               <span> 
                    {
                        !this.props.flag?
                            <Select  placeholder={'请选择数据类型'}  style={{width:200,marginRight:'10px'}}  onChange={this.props.selectChange}> 
                            ...
                            : 
                            <Select  placeholder={'请选择分析类型'}  style={{width:200,marginRight:'10px'}}  onChange={this.props.selectChange}>
               ...
               <span className={this.props.dataFlag===0||this.props.dataFlag===1?'':'hide'}> 
                   <Select style={{width:150,marginRight:'20px'}} placeholder={'请选择物料类型'} onChange={this.props.selectChange}>
