...
import './stattic.css'
 class PositiveProductLine extends Component{
    ...
    render(){
        ...
        {periodCode,loading,lineNameData,res,data,periods,beginTime,endTime}=this.state
        return(
            <Spin spinning={loading}>
                <Search onChange={this.onChange}  selectChange={this.selectChange}
                        staticPeriod={staticPeriod} periodCode={periodCode} getTableData={this.getTableData}
                         lineNameData={lineNameData} periods={periods} beginTime={beginTime} endTime={endTime}
                />
