    ...
    render() {
        return (
            <span>
                ...
                <Button type="primary" disabled={!this.props.selectedRowKeys.length>0} className={this.props.selectedRowKeys.length>0?'blue':'grey'}><i className="fa fa-trash" aria-hidden="true"></i>&nbsp;删除</Button>
                </Popconfirm>
            </span>
        );
    }
