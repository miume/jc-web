...
import "../rawTestReport/rawTestReport.css"
...
class Print extends Component {
    ...
    render() {
        const printId = `print_data${this.props.sampleDeliveringRecordId}`;
            ...
            <span>
                ...
                <div className="printModal_print">
                    <div id={printId} style={{fontFamily:"Arial Normal,Arial",fontStyle:"normal",color:"#333333",lineHeight:"normal"}}>
                        <div style={{fontSize:"15px"}}>{this.props.record.batch}</div>
                        ...
                        <div style={{fontSize:"8px"}}>送检时间：&nbsp;{this.props.record.sampleDeliveringRecord.sampleDeliveringDate}</div>
                    </div>
                </div>
            </span>
        )
