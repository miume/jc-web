...
class TraceabilityBeforeDisassembly extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
        ...
        this.columns = [{
            ...
            title: '电池包溯源码',
            key: 'batterypacktracecode',
            dataIndex: 'batterypacktracecode',
            width: '25%'
        },{
            title: '模组溯源码',
            key: 'moduletracecode',
            dataIndex: 'moduletracecode',
            width: '25%'
        },{
            title: '单体溯源码',
            key: 'singletracecode',
        ...
        return (
            <div>
                ...
                <Spin spinning={this.state.loading} wrapperClassName='rightDiv-content'>
                    ...
                    <SearchCell flag={true} searchEvent={this.searchEvent} reset={this.reset} placeholder={'电池包溯源码'}/>
    ...
    getTableData(params,searchContent) {
        ...
        axios({
            url: `${this.url.TraceabilityBeforeDisassembly.page}?condition=${searchContent}&page=${params.current}&size=${params.size}`,
            method: 'get',
            headers: {
    ...
    deleteById(id) {
        debugger
        axios({
            url:`${this.url.TraceabilityBeforeDisassembly.delete}/${id}`,
            method:'Delete',
            headers:{
                'Authorization':this.url.Authorization
            }
    ...
    deleteByIds() {
        ...
        axios({
            url:`${this.url.TraceabilityBeforeDisassembly.deletes}`,
...
export default TraceabilityBeforeDisassembly;
