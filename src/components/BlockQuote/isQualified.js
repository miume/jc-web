...
class IsQualified extends React.Component {
    render() {
        ...
        switch(this.props.status) {
            case 0:
                return(
                    <div style={{border:'3px solid #FF3B30',width:'200px',float:'right',top:-60,position:'relative'}}>
            ...
            case 1:
                return(
                    <div style={{border:'3px solid #4BD863',width:'200px',float:'right',top:-60,position:'relative'}}>
