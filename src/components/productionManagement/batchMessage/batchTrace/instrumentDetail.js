                ...
                >
                    <div style={{height:'615px'}}>
                        ...
                        <div style={{display:this.state.tableDisplay}}>
                            <Table columns={this.column} dataSource={this.state.data} pagination={false} size="small" bordered scroll={{y:500}}  rowKey={record=>record.type}/>
                        </div>
                        ...
                        <div style={{display:this.state.detailTableDisplay}} >
                              <Table columns={this.column1} dataSource={this.state.detailData} pagination={false} scroll={{y:500}} size="small" bordered rowKey={record=>record.index}/>
                        </div>
                    </div>
                </Modal>
            </div>
