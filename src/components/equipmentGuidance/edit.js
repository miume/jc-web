            ...
            <span>
                ...
                >
                      <div style={{height:'400px'}}>
                            <Input style={{width:"32%"}} placeholder='请输入指导书名称' value="指导书1"/>
                            <Input style={{width:"32%",marginLeft:'2%'}} placeholder='请输入编号' value="编号1"/>
                            <Input style={{width:"32%",marginLeft:'2%'}} placeholder='请输入版次' value="版次1"/>
