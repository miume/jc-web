...
class Tr extends React.Component{
    ...
    render(){
        ...
        return(
            <tr><td className="isDefault"><Input onChange={this.codeChange} style={{border:'none',textAlign:'left'}} value={this.props.value.ruleValue} /></td>
                <td className="isDefault"><Input onChange={this.desChange} style={{border:'none',textAlign:'left'}} value={this.props.value.ruleDesc} /></td>
