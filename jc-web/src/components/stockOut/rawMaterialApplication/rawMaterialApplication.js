    ...
    render(){
        ...
        return (
            <div style={{padding:'0 15px'}}>
                <ApplyStockOut selectedRowKeys={this.state.selectedRowKeys} data={this.state.dataSource} cancle={this.cancle} server={this.server} Authorization={this.Authorization} fetch={this.fetch} />
